...
<img src="/assets/ejer08.png" alt="actividad 308" style="zoom:80%;" />
...
- `Trabajador` es una clase abstracta que ahora almacena los `telefonos` y donde `calcularSueldo` es un método abstracto de manera que:
  ...
  - Para los `Gerente`s, su sueldo se incrementa porcentualmente en base a su edad: `salario + salario*edad/100`
    ...
    <img src="/assets/ejer13.png" alt="Actividad 313" style="zoom:80%;" />
...
<img src="/assets/pro21.png" style="zoom: 80%;" />
...
<img src="/assets/pro22.png" style="zoom:80%;" />
...
<img src="/assets/pro05.png" alt="img" style="zoom:70%;" />
